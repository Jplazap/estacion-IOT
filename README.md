...
Librería de UI	React (Vite)
Base de datos en tiempo real	Firebase Realtime Database (RTDB)
...
Una cuenta y un proyecto creado en Firebase con Realtime Database habilitada
Pasos
...
Configurar las variables de entorno Crear un archivo .env en la raíz del proyecto (ver sección Variables de entorno).
...
Plaza Pisanan Jorge Enrique 8vo Nivel de Telemática "A" Facultad de Ciencias de la Computación y Diseño Digital Universidad Técnica Estatal de Quevedo (UTEQ)

Docente: Ing. Zambrano Vega Cristian Gabriel

📄 Licencia

Este proyecto se desarrolló con fines académicos como parte del curso de Telemática (Aplicaciones Telemáticas) de la UTEQ. Puedes adaptar la licencia según las políticas de tu institución o repositorio (por ejemplo, MIT License).
